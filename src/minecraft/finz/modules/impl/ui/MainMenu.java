...
public class MainMenu extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        mc.getTextureManager().bindTexture(new ResourceLocation("finz/main.jpg"));
        ...
        this.drawCenteredStringF(mc.fontRendererObj, FinZ.INSTANCE.getName(), width / 2.4f, height / 2f - mc.fontRendererObj.FONT_HEIGHT / 2f, 0xFFFFFF);
