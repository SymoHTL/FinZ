...
public class HUD extends Module {
    ...
    public void on2D(Event2D event) {
        ...
        // Client name
        fr.drawStringWithShadow(FinZ.INSTANCE.getName() + " v" + FinZ.INSTANCE.getVersion(), (float) (2 + stripeWidth), 2, 0xFFFFFFFF);
        Gui.drawRectDouble(
                0,
                0,
                stripeWidth,
        ...
        // Modules
        ModuleManager manager = FinZ.INSTANCE.getManager();
