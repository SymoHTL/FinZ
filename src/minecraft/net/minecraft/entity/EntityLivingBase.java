...
public abstract class EntityLivingBase extends Entity
{
    ...
    public boolean canSeeEyesMidOrFeet(Entity entityIn)
    {
        return canSeeEyes(entityIn) || canSeeMid(entityIn) || canSeeFeet(entityIn);
    }
    public boolean canSeeEyes(Entity entityIn)
    {
        return this.worldObj.rayTraceBlocks(new Vec3(this.posX, this.posY + (double)this.getEyeHeight(), this.posZ), new Vec3(entityIn.posX, entityIn.posY + (double)entityIn.getEyeHeight(), entityIn.posZ)) == null;
    }
    public boolean canSeeMid(Entity entityIn)
    {
        return this.worldObj.rayTraceBlocks(new Vec3(this.posX, this.posY + (double)this.getEyeHeight(), this.posZ), new Vec3(entityIn.posX, entityIn.posY + entityIn.height * 0.5D, entityIn.posZ)) == null;
    }
    public boolean canSeeFeet(Entity entityIn)
    {
        return this.worldObj.rayTraceBlocks(new Vec3(this.posX, this.posY + (double)this.getEyeHeight(), this.posZ), new Vec3(entityIn.posX, entityIn.posY + entityIn.height * 0.15D, entityIn.posZ)) == null;
    }
